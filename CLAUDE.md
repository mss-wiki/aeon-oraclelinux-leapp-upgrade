...
The README documents Oracle Linux in-place upgrades (OL7 → OL8) using the LEAPP tool, covering the full upgrade procedure and post-upgrade boot failure troubleshooting (dracut / LVM volume group name mismatches).
